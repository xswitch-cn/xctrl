...
import (
	...
	"git.xswitch.cn/xswitch/xctrl/stack/api/resolver"
	"git.xswitch.cn/xswitch/xctrl/stack/api/resolver/vpath"
	"git.xswitch.cn/xswitch/xctrl/stack/api/router"
	regRouter "git.xswitch.cn/xswitch/xctrl/stack/api/router/registry"
